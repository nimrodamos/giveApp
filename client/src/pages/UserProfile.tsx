...
//       console.log("Donations API Response:", donationsRes.data);
//       setProjects(projectsRes.data.projects || []);
//       setDonations(donationsRes.data.donations || []); // Ensure donationsRes.data.donations exists and is an array
//       console.log("Donations State:", donationsRes.data.donations); // Verify state update
//     } catch (error) {
//       console.error("Failed to fetch user data:", error);
//     } finally {
//       setLoading(false);
...
//       {/* Debugging State */}
//       <pre className="text-sm text-muted-foreground">{JSON.stringify(donations, null, 2)}</pre>
...
//                 </p>
//                 <p className="text-sm text-muted-foreground">
//                   Date: {donation.date ? new Date(donation.date).toLocaleDateString() : "Unknown Date"}
//                 </p>
//               </li>
//             ))}
//           </ul>
