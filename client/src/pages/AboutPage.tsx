      ...
      <div className="flex flex-col items-center py-8">
        ...
        <div className="max-w-3xl text-center">
          <p className="text-lg leading-relaxed">
            About Us We are a team of three passionate full-stack developer
            students, united by a shared commitment to innovation and teamwork.
            With a solid foundation in software development and problem-solving,
            we aim to create impactful digital solutions that address real-world
            challenges. All of us bring unique perspectives shaped by our
            experiences in the military, where we served in combat roles. These
            roles not only instilled in us discipline, resilience, and
            adaptability but also taught us the importance of collaboration and
            clear communication—values we carry into every project we tackle.
            Participating in this hackathon is an exciting opportunity for us to
            push our boundaries, learn from each other, and deliver a full-stack
            product that embodies our dedication and creativity. We are thrilled
            to contribute to a project that reflects our technical skills,
            teamwork, and determination to make a difference.
          </p>
        </div>
      </div>
    </>
